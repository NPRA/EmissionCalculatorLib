# coding: utf-8
from sqlalchemy import Column, Float, Index, Integer, LargeBinary, String, Table, Text
...
print("SQLITE full path: {}".format(sqlite_full_path))

Base = declarative_base()
metadata = Base.metadata

# Create the engine connected to the sqlite db
db_engine = create_engine('sqlite:///{}'.format(sqlite_full_path), echo=True)
